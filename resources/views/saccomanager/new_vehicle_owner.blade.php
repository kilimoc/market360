        ...
        <div class="container">
            ...
            <div class="form-outer text-center d-flex align-items-center">
                <div class="form-inner">
                    <div class="logo text-uppercase"><span>Vehicle Owner</span><strong class="text-primary"> Registration</strong></div>
                    <p>@include('flash_message')</p>
                    <form class="text-left form-validate" method="post" action="{{route('newOwner.submit')}}">
                        @csrf
